...
--
-- Name: students_student_id_seq; Type: SEQUENCE; Schema: public; Owner: vagrant
--
...
ALTER TABLE public.students_student_id_seq OWNER TO vagrant;

--
-- Name: students_student_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: vagrant
--
...
--
-- Name: students student_id; Type: DEFAULT; Schema: public; Owner: vagrant
--
...
10	shwetas	Markov	20
11	udayb	blockly	10
12	shrutis	black jack	10
\.
...
2	blockly	block game using java	50
3	black jack	online black jack card game	50
4	numpy	numpy demo	50
\.
...
COPY public.students (student_id, first_name, last_name, github) FROM stdin;
1	shweta	S	shwetas
2	uday	B	udayb
3	shruti	S	shrutis
\.
...
--
-- Name: students_student_id_seq; Type: SEQUENCE SET; Schema: public; Owner: vagrant
--
